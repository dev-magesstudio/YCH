...
//     version 1.8.1
//     from Assets/Samples/Apple visionOS XR Plugin/1.2.3/VR Sample - URP/Scripts/Input/PointerInput.inputactions
//
...
public partial class @PointerInput: IInputActionCollection2, IDisposable
{
    ...
    ~@PointerInput()
    {
        Debug.Assert(!m_Default.enabled, "This will cause a leak and performance issues, PointerInput.Default.Disable() has not been called.");
    }
