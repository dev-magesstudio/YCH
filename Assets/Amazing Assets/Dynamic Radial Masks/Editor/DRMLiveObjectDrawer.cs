    ...
    public class DRMLiveObjectDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            EditorGUI.BeginProperty(position, label, property);
            {
                ...
                //Foldout
                float offset = (Application.unityVersion.Contains("2019") || Application.unityVersion.Contains("2020") || Application.unityVersion.Contains("2021")) ? 18 : 4;
                property.isExpanded = EditorGUI.Foldout(new Rect(position.xMin + offset, position.yMin + 1, position.width - 80, position.height), property.isExpanded, GUIContent.none, true);
