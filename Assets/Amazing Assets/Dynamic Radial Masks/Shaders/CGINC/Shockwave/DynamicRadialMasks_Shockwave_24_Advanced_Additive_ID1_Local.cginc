...
float4 DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local_DATA1[24];	
float4 DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local_DATA2[24];	
#endif
...
[unroll]	for(i = 0; i < 24; i++)
	{
		retValue += ShaderExtensions_DynamicRadialMasks_Shockwave_Advanced(positionWS, 
																					DYNAMIC_RADIAL_MASKS_READ_POSITION(DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_RADIUS(DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_INTENSITY(DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_EDGE_SIZE(DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_SMOOTH(DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_NOISE_STRENGTH(DynamicRadialMasks_Shockwave_24_Advanced_Additive_ID1_Local, i) * noise);
	}		
