...
float4 DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local_DATA1[1];	
float4 DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local_DATA2[1];
#endif
...
)
{
...

	{
		retValue += ShaderExtensions_DynamicRadialMasks_Dot_Advanced(positionWS, 
																					DYNAMIC_RADIAL_MASKS_READ_POSITION(DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_RADIUS(DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_INTENSITY(DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local, i), 
																					DYNAMIC_RADIAL_MASKS_READ_NOISE_STRENGTH(DynamicRadialMasks_Dot_1_Advanced_Additive_ID1_Local, i) * noise);
	}		
